...
public class BLECharacteristicDialog extends DialogFragment implements DialogInterface.OnClickListener {

    private String title;
    private BLEServiceGATT service;
...
//            Utils.toast(activity.getApplicationContext(), "Button " + Integer.toString(which) + " Pressed");
    ...
    public void setService(BLEServiceGATT service) {
