 ...
 */
public class BLEListAdapterServices extends BaseExpandableListAdapter {
    ...
    public BLEListAdapterServices(Activity activity, ArrayList<BluetoothGattService> listDataHeader,
