...
public class Utils {
    ...
    public static IntentFilter makeGattUpdateIntentFilter() {
        ...
        intentFilter.addAction(BLEServiceGATT.ACTION_GATT_CONNECTED);
        intentFilter.addAction(BLEServiceGATT.ACTION_GATT_DISCONNECTED);
        intentFilter.addAction(BLEServiceGATT.ACTION_GATT_SERVICES_DISCOVERED);
        intentFilter.addAction(BLEServiceGATT.ACTION_DATA_AVAILABLE);
